        ...
        for year in range(2006, 2024)[::-1]:
            ...
            for i in range(start, len(chart_data)):
                ...
                results = "https://youtube.com/watch?v=" + \
                          YoutubeSearch(song_title + ' lyric video', max_results=1).videos[0]['id']
                results_karaoke = "https://youtube.com/watch?v=" + \
                                  YoutubeSearch(song_title + ' karaoke', max_results=1).videos[0]['id']
